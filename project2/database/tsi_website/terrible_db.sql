...
(3, 'alex', 'alex@email.com', 1),
(4, 'mia', 'mia@email.com', 0);
...
--
CREATE DATABASE IF NOT EXISTS `exhibition_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `exhibition_db`;
...
('root', '[{\"db\":\"terrible_db\",\"table\":\"eoi\"},{\"db\":\"terrible\",\"table\":\"eoi\"},{\"db\":\"exhibition_db\",\"table\":\"cars\"},{\"db\":\"blog_site\",\"table\":\"posts\"},{\"db\":\"blog_site\",\"table\":\"users\"},{\"db\":\"university\",\"table\":\"students\"}]');
...
('root', '2025-05-21 06:26:02', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":643}');
